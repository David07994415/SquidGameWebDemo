        ...
        <>
            <Link to={`star/${props.id}`} >
                <div className='relative max-w-[250px]'>
                    <img className='w-full rounded-xl transform hover:scale-105 transition duration-300 ease-in-out hover:border-pink-main hover:border-2' src={Star} alt="Star" loading="lazy" />
